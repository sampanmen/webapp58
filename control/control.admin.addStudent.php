...
if (($res = addUser($get_id, $get_titlename, $get_name, $get_sname, $get_username, $get_password, $get_status, $get_position, $get_permission, $get_classid)) != FALSE) {
    header("Location: ../Admin/AviewStudent.php?p=add_student_completed&roomid=" . $get_classid);
    //echo "yes";
} else {
    header("Location: ../Admin/AviewStudent.php?p=add_student_error&roomid=" . $get_classid);
//    echo "no";
}
