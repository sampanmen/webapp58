                            ...
                            <script>
                                ...
                                $.post(url, function (data) {
                                    ...
                                    for (var key in jsonData) {
                                        ...
                                        t = t + "<td><button class='btn btn-default'><a href='../Admin/Amodal_editAllSubject.php?subjectid=" + jsonData[key]['idSubject'] + "' data-toggle='modal' data-target='#myModal'>รายละเอียด</a></button></td>";
                                        t = t + "</tr>";
                                        i++;
