...
<div id="wrapper">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">วิชาที่เปิด เทอม <?= $_GET['term'] ?> ปี <?= $_GET['year'] ?>  <button class="btn btn-circle glyphicon-plus" href="Amodal_addSubject.php?term=<?= $_GET['term'] ?>&year=<?= $_GET['year'] ?>" data-toggle="modal" data-target="#myModal1-lg"></button></h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
